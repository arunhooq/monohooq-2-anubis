...
# helloworld Service
module "helloworld-metricbeat-ecs-service" {
  ...
  cluster_name                   = data.terraform_remote_state.cloudsrehelloworld_infra_state.outputs.ecs_cluster_name
...
output "ecs_container_definition" {
  value = module.helloworld-metricbeat-ecs-service.ecs_container_definition
}
output "ecs_task_definition_arn" {
  value = module.helloworld-metricbeat-ecs-service.ecs_task_definition_arn
}

output "ecs_service_name" {
  value = module.helloworld-metricbeat-ecs-service.ecs_service
}
