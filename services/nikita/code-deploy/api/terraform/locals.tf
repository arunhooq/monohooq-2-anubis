...
locals {
  ...
  alb_targetgroups_arns = data.terraform_remote_state.nikita_infra_state.outputs.api_alb_targetgroups_arns
  alb_targetgroup_names = data.terraform_remote_state.nikita_infra_state.outputs.api_alb_targetgroup_names
}

locals {
  // ECS
  cluster_name              = data.terraform_remote_state.nikita_infra_state.outputs.api_ecs_cluster_name
  ...
  ecs_service_name          = module.nikita-api.ecs_service
...
locals {
  ...
  load_balancer                       = data.terraform_remote_state.nikita_infra_state.outputs.api_alb_dnsname
}
