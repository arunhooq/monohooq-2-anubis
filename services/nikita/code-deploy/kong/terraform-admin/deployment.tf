...
# nikita kong admin Service
module "nikita-kong-admin" {
...
module "ecs_service_autoscaling_policy_scale_up" {
  ...
  name                         = "${module.nikita-kong-admin.ecs_service}-scale-up"
  cooldown                     = 60
  ecs_service_name             = module.nikita-kong-admin.ecs_service
  ecs_cluster_name             = local.cluster_name
...
module "ecs_service_autoscaling_policy_scale_down" {
  ...
  name                           = "${module.nikita-kong-admin.ecs_service}-scale-down"
  cooldown                       = 60
  ecs_service_name               = module.nikita-kong-admin.ecs_service
  ecs_cluster_name               = local.cluster_name
  adjustment_type                = "ChangeInCapacity"
...
output "ecs_container_definition" {
  value = module.nikita-kong-admin.ecs_container_definition
}

output "ecs_task_definition_arn" {
  value = module.nikita-kong-admin.ecs_task_definition_arn
}

output "ecs_service_name" {
  value = module.nikita-kong-admin.ecs_service
}
