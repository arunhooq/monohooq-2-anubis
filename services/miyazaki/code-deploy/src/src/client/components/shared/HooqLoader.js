...
import './HooqLoader.scss';

const mapStateToProps = state => ({
  loading: state.loading
});

class HooqLoader extends Component {
  render() {
    ...
    return (
      <React.Fragment>
        <div className="loader-wrapper">
          ...
          <p className="loader-text">To infinity and beyond</p>
        </div>
      </React.Fragment>
    );
  }
