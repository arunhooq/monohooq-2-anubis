...
variable "monitoring_rds_service_role_name" {
  description = "monitoring rds role name"
  type        = string
  default     = ""
}

variable "monitoring_rds_service_role_arn" {
  description = "monitoring rds role arn"
  type        = string
  default     = ""
}
